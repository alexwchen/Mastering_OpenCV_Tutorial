...
The idea is that you need to find  OpenCVConfig.cmake, which is in /opt/local/lib/cmake/
if you don't know where that file is, try search it in finder

This post is not related, but it might be helpful:
